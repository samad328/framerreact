...
import Img from '../images/best.png'
import icon from '../images/icon.png'
function Box1(props) {
    let [pak, setPak]= useState(1)


let dataSection= useRef(null)
useEffect(()=>{
...
function khan(){
 setPak(++pak)
  ...
  return (
    <motion.div className='box1'  onClick={props.bo1}
...
<div class="card-header">
    ...
    <h1 class="card-fullname">Abdul Samad</h1>
    <h2 class="card-jobtitle">Fron-End Web Developer</h2>
  </div>
  ...
  <div className="card-main">
    <div className="card-section is-active" id="about">
      <div className="card-content">
        ...
        <p className="card-desc">Hey, I'm Abdul Samad But you can call me Buntee. I'm a Front-End, WordPress, Webflow and Framer Developer. I love Criket and UFC </p>
      </div>
      ...
      <div className="card-content">
        ...
        <div className="card-timeline">
          <div className="card-item" data-year="2021">
            <div className="card-item-title">Front-end Developer at <span>Fiverr</span></div>
            <div className="card-item-desc">Currently I'm working as a Wordpress and Front-end Web developer at Fiverr. </div>
          </div>
          <div className="card-item" data-year="2019">
            <div className="card-item-title">WEB DEV INTERN at <span>Zeeshan Software House</span></div>
            <div className="card-item-desc">
              Worked as an web internee at a local Software House called (Zeeshan Softeare House). </div>
          </div>
      ...
      <div className="card-content">
        ...
        <div className="card-contact-wrapper">
          <div className="card-contact">
            ...
            Mussafah Industrial Area 17 UAE
          </div>
          <div className="card-contact icon">
            
            <img className='image-icon' src={icon} />  <span> (+971) 554893450 </span></div>
          <div className="card-contact">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
              <path d="M22 6l-10 7L2 6" /></svg>

abdulsamadmahsud@gmail.com          </div>
          <button className="contact-me">WORK TOGETHER</button>
        </div>
      </div>
    </div>
    <div className="card-buttons">
      <button onClick={(e)=>{handleButtonClick(e)}} data-section="#about" className="is-active">ABOUT</button>
      <button onClick={(e)=>{handleButtonClick(e)}} data-section="#experience">EXPERIENCE</button>
      <button onClick={(e)=>{handleButtonClick(e)}} data-section="#contact">CONTACT</button>
    </div>
  </div>
</div>
